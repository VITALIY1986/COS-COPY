...
const Footer = () => (
	<div className="footer bg-white shadow-2xl text-futer px-6 py-6 ">
		<div className="flex flex-col items-center">
			...
			<div className="bg-grey_cos  p-3 rounded-full mx-1 shadow-xl"><a href="#"><Facebook/></a></div><div className="bg-grey_cos  p-3 rounded-full mx-1 shadow-xl"><a href="#"><Instagram/></a></div>
			</div>
			</div>
