    ...
    return (
        <div className={containerClassNames}>
            ...
            <input
                ...
                type={type}
                name={name}
                className="w-full bg-white bg-opacity-50 rounded border border-gray-500 focus:border-indigo-500 focus:bg-transparent focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-800 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                id={inputId}
            />
